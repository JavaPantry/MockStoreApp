Ext.define('QuotaKPI.view.imports.ImportInvoice', {
	extend: 'Ext.grid.Panel', 
	alias: 'widget.ImportInvoice'
    ,columnLines: true
    //,store: 'dealer.Dealer'
	...
	,dockedItems : [{xtype: 'toolbar',dock: 'top',
							    items: [{iconCls: 'icon-add',		itemId: 'downloadInvoiceExcel',text: 'Download Invoice Excel Template',action: 'downloadInvoiceExcelTemplate'},
							            //{iconCls: 'icon-add',		itemId: 'uploadInvoiceExcel',text: 'Upload Invoice Import Excel',action: 'uploadInvoiceExcel'},
							            {xtype:'form',padding: '0 0 0 0',frame: true
											  ,items : [{xtype:'filefield',name:'fileUpload'
														,itemId: 'forecastUploadExelActuals'
														,buttonOnly: true
														,buttonText:'Upload Invoice Import Excel'
													  ,listeners:{
