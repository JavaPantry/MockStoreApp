...
public class BeanUtility {
	...
	static String[] defaultExludeProperties={//"id",
											"version","class"};
	/**
		...
		try {
			...
			for (Iterator iterator = keys.iterator(); iterator.hasNext();) {
				...
				if(value!=null && (value instanceof String) && ((String)value).length()!=0){
					...
					/*
					 * TODO - <AP> Sonar  Major   Try-catch blocks should not be nested. Extract this nested try block into a separate method.
					 */
					try {
